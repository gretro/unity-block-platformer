...
{
    public class GameQuery<TReturn>
    {
        ...
        public GameQuery(string queryName, TReturn notHandledDefault = default)
        {
    ...
    public class GameQuery<T1, TReturn>
    {
        public readonly string queryName;
    ...
    public class GameQuery<T1, T2, TReturn>
    {
        public readonly string queryName;
    ...
    public class GameQuery<T1, T2, T3, TReturn>
    {
        public readonly string queryName;
    ...
    public class GameQuery<T1, T2, T3, T4, TReturn>
    {
        public readonly string queryName;
